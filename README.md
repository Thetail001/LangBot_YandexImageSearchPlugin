...
```
!plugin get https://github.com/Thetail001/LangBot_YandexImageSearchPlugin
```
或查看详细的[插件安装说明](https://qchatgpt.rockchin.top/develop/plugin-intro.html#%E6%8F%92%E4%BB%B6%E7%94%A8%E6%B3%95)

## 使用

使用提示：安装之后可进入本插件安装目录下的Config.py配置代理，不配置也可以，除非你是使用不了yandex搜图的地区，如香港IP,然后输出”/yan“开头的命令进行搜图,示例中是”/si“，可在”main.py“自行修改相关代码进行热重载修改触发命令。

效果:
![080f56445b24bcabbd5a7fc41a18a946](https://github.com/user-attachments/assets/b373401d-08e8-473e-960a-dc917011093e)
